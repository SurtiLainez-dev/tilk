                ...
                <v-list-item-content>
                  <v-list-item-title class="title">
                    <v-btn color="warning" x-small tile dark fab
                           @click="VISTA = 1"><v-icon >fa fa-arrow-left</v-icon></v-btn>
                    {{tituloMenu}}
                  </v-list-item-title>
                </v-list-item-content>
              </v-list-item>
...
<script>
import Vue from "vue";
import datos_personales from "@/components/cliente/datos_personales.vue";
import detalles_cliente from "@/components/cliente/detalles_cliente.vue";
import telefonos_cliente from "@/components/cliente/telefonos_cliente.vue";
import direcciones_cliente from "@/components/cliente/direcciones_cliente.vue";
import documentos_cliente from "@/components/cliente/documentos_cliente.vue";
import cuentas_clientes from "@/components/cliente/cuentas_clientes.vue";
import solicitudes_cliente from "@/components/cliente/solicitudes_cliente.vue";
import notas_cliente from "@/components/cliente/notas_cliente.vue";
