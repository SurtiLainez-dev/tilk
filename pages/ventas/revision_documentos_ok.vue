...
export default {
  ...
  created() {
    this.$store.commit('guardarTitulo','Facturación > Ventas > Revisión de Documentos Revisados');
    this.$store.commit('cuentas/cargar_VENTAS_REV_DOC_OK');
  },
  methods:{
    goVenta(data){
      this.venta = data;
